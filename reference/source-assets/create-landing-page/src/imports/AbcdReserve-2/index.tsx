import svgPaths from "./svg-i6bq7zr07y";
...
import { imgBackground } from "./svg-nnhxg";
...
function Text6() {
  return (
    <div className="bg-[#5c1d2a] content-stretch drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] flex items-center justify-center relative rounded-[9999px] shrink-0 size-[28px]" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">3</p>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="h-[20px] relative shrink-0 w-[94.5px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[47.5px] not-italic text-[#3e2a28] text-[14px] text-center top-[0.5px] whitespace-nowrap">Your details</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Playfair_Display:Regular',sans-serif] font-normal leading-[32px] relative shrink-0 text-[#3e2a28] text-[24px] whitespace-nowrap">Your details</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p2c395540} id="Vector" stroke="var(--stroke-0, #8C7A77)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
      </svg>
    </div>
  );
...
function Label() {
  return (
    <div className="h-[17px] relative shrink-0 w-[271.328px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[2px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[15px] not-italic relative shrink-0 text-[#8c7a77] text-[10px] tracking-[0.25px] uppercase whitespace-nowrap">Full Name</p>
      </div>
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="absolute content-stretch flex flex-col h-[22.5px] items-start justify-center left-0 overflow-clip top-px w-[271.328px]" data-name="Text Input">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[22.5px] not-italic relative shrink-0 text-[#3e2a28] text-[15px] w-full">Alex Morgan</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="flex-[271.328_0_0] min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Label />
        <InlineContent />
      </div>
...
function Container10() {
  return (
    <div className="col-1 justify-self-stretch relative rounded-[12px] row-1 self-stretch shrink-0" data-name="Container">
...
function Label1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[15px] not-italic relative shrink-0 text-[#8c7a77] text-[10px] tracking-[0.25px] uppercase whitespace-nowrap">Mobile Number</p>
      </div>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="h-[18px] relative shrink-0 w-[17px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[18px] left-0 not-italic text-[#3e2a28] text-[18px] top-0 whitespace-nowrap">🇺🇸</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Icon">
          <path d="M9.5 4.5L6 8L2.5 4.5" id="Vector" stroke="var(--stroke-0, #8C7A77)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </div>
  );
...
function Container14() {
  return (
    <div className="content-stretch flex items-center pr-[9px] relative rounded-[4px] shrink-0 w-[42px]" data-name="Container">
      <div aria-hidden className="absolute border-[#e8dfd5] border-r border-solid inset-0 pointer-events-none rounded-[4px]" />
      <TextMargin4 />
      <Icon2 />
    </div>
  );
...
function PhoneInput() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[253.336px]" data-name="Phone Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[22.5px] not-italic relative shrink-0 text-[#3e2a28] text-[15px] w-full">(415) 555-0123</p>
      </div>
    </div>
  );
}
...
function ContainerMargin3() {
  return (
    <div className="relative shrink-0 w-[303.336px]" data-name="Container (margin)">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pt-[2px] relative size-full">
        <ContainerMargin4 />
        <PhoneInput />
      </div>
    </div>
...
function Container13() {
  return (
    <div className="relative shrink-0 w-[303.336px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Label1 />
        <ContainerMargin3 />
      </div>
...
function Container12() {
  return (
    <div className="col-2 justify-self-stretch relative rounded-[12px] row-1 self-stretch shrink-0" data-name="Container">
      <div aria-hidden className="absolute border border-[#e8dfd5] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[13px] relative size-full">
          <Container13 />
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p80d7900} id="Vector" stroke="var(--stroke-0, #8C7A77)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
      </svg>
    </div>
  );
...
function Label2() {
  return (
    <div className="h-[17px] relative shrink-0 w-[271.328px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[2px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[15px] not-italic relative shrink-0 text-[#8c7a77] text-[10px] tracking-[0.25px] uppercase whitespace-nowrap">Email Address</p>
      </div>
    </div>
  );
}
...
function EmailInput() {
  return (
    <div className="absolute content-stretch flex flex-col h-[22.5px] items-start justify-center left-0 overflow-clip top-px w-[271.328px]" data-name="Email Input">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[22.5px] not-italic relative shrink-0 text-[#3e2a28] text-[15px] w-full">alex.morgan@gmail.com</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="col-1 justify-self-stretch relative rounded-[12px] row-2 self-stretch shrink-0" data-name="Container">
      <div aria-hidden className="absolute border border-[#e8dfd5] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[13px] relative size-full">
          <IconMargin1 />
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p2c8b6d80} id="Vector" stroke="var(--stroke-0, #8C7A77)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
      </svg>
    </div>
  );
...
function Label3() {
  return (
    <div className="h-[17px] relative shrink-0 w-[271.336px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[2px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[15px] not-italic relative shrink-0 text-[#8c7a77] text-[10px] tracking-[0.25px] uppercase whitespace-nowrap">Occasion (Optional)</p>
      </div>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="absolute content-stretch flex flex-col h-[22.5px] items-start justify-center left-0 overflow-clip top-px w-[271.328px]" data-name="Text Input">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[22.5px] not-italic relative shrink-0 text-[#3e2a28] text-[15px] w-full">Birthday</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="flex-[271.336_0_0] min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Label3 />
        <InlineContent2 />
      </div>
...
function Icon5() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.pb7adf00} id="Vector" stroke="var(--stroke-0, #8C7A77)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Container17() {
  return (
    <div className="col-2 justify-self-stretch relative rounded-[12px] row-2 self-stretch shrink-0" data-name="Container">
      <div aria-hidden className="absolute border border-[#e8dfd5] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[13px] relative size-full">
          <IconMargin2 />
...
function Icon6() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.pac89d00} id="Vector" stroke="var(--stroke-0, #8C7A77)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
      </svg>
    </div>
  );
...
function IconMargin3() {
  return (
    <div className="relative shrink-0" data-name="Icon (margin)">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start pr-[12px] pt-[4px] relative size-full">
        <Icon6 />
      </div>
    </div>
  );
...
function Label4() {
  return (
    <div className="h-[19px] relative shrink-0 w-[573.164px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[4px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[15px] not-italic relative shrink-0 text-[#8c7a77] text-[10px] tracking-[0.25px] uppercase whitespace-nowrap">Special Request (Optional)</p>
      </div>
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="flex-[45_0_0] min-h-px relative w-[573.164px]" data-name="Text Area">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[18.75px] not-italic relative shrink-0 text-[#9ca3af] text-[15px] w-full">e.g. Dietary requirements, allergies...</p>
      </div>
    </div>
  );
}
...
function Text9() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-[35.5px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[16.5px] left-0 not-italic text-[#8c7a77] text-[11px] top-[0.5px] whitespace-nowrap">26/120</p>
      </div>
    </div>
  );
}
...
function ContainerMargin5() {
  return (
    <div className="h-[64px] relative shrink-0 w-[43.5px]" data-name="Container (margin)">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-end justify-end pl-[8px] relative size-full">
        <Text9 />
      </div>
    </div>
  );
...
function Container19() {
  return (
    <div className="col-[1/span_2] justify-self-stretch min-h-[90px] relative rounded-[12px] row-3 self-stretch shrink-0" data-name="Container">
      <div aria-hidden className="absolute border border-[#e8dfd5] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="content-stretch flex items-start min-h-[inherit] p-[13px] relative size-full">
        <IconMargin3 />
        <Container20 />
        <ContainerMargin5 />
      </div>
...
function Container9() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid gap-x-[16px] gap-y-[16px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(3,fit-content(100%))] relative size-full">
        <Container10 />
        <Container12 />
        <Container15 />
        <Container17 />
...
function Text10() {
  return (
    <div className="h-[24px] relative shrink-0 w-[156px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[78.5px] not-italic text-[16px] text-center text-white top-[-1px] whitespace-nowrap">Confirm Reservation</p>
      </div>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] relative rounded-[9999px] shrink-0 size-[32px]" data-name="Text">
...
function Button4() {
  return (
    <div className="bg-[#5c1d2a] drop-shadow-[0px_4px_3px_rgba(0,0,0,0.1),0px_2px_2px_rgba(0,0,0,0.1)] relative rounded-[12px] shrink-0 w-full" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[24px] items-center justify-center py-[16px] relative size-full">
        <Text10 />
        <Text11 />
      </div>
    </div>
...
function Form() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Form">
...
function Container8() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative rounded-[16px] w-full" data-name="Container">
      <Heading1 />
      <Form />
    </div>
  );
...
function ContainerMargin2() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="Container (margin)">
...
function ContainerMargin1() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container (margin)">
      <div className="content-stretch flex gap-[36px] items-start pb-[55px] pt-[44.8px] px-[102px] relative size-full">
        <Container5 />
        <Sidebar />
      </div>
    </div>
