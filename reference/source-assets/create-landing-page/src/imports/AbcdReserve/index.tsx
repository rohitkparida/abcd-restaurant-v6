import svgPaths from "./svg-qhrkf0x4wn";
...
import { imgBackground } from "./svg-5yy5p";
...
function Text3() {
  return (
    <div className="bg-[#5c1d2a] content-stretch drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] flex items-center justify-center relative rounded-[9999px] shrink-0 size-[28px]" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">1</p>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="content-stretch flex items-center justify-center p-px relative rounded-[9999px] shrink-0 size-[28px]" data-name="Text">
      ...
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#5c1d2a] text-[12px] text-center whitespace-nowrap">2</p>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 2">
      <p className="[word-break:break-word] font-['Playfair_Display:Regular',sans-serif] font-normal leading-[36px] relative shrink-0 text-[#3e2a28] text-[30px] whitespace-nowrap">Select your date</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="content-stretch flex flex-col h-[28px] items-start pt-[8px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#8c7a77] text-[14px] whitespace-nowrap">Reservations can be booked up to 90 days in advance.</p>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="h-[28px] relative shrink-0 w-[78.5px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Playfair_Display:SemiBold',sans-serif] font-semibold leading-[28px] left-0 text-[#3e2a28] text-[18px] top-0 whitespace-nowrap">May 2026</p>
      </div>
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p3f953000} id="Vector" stroke="var(--stroke-0, #8C7A77)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button4() {
  return (
    <div className="opacity-50 relative rounded-[8px] shrink-0" data-name="Button">
      <div aria-hidden className="absolute border border-[#e8dfd5] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center p-[7px] relative size-full">
        <Icon1 />
      </div>
    </div>
  );
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p43eff00} id="Vector" stroke="var(--stroke-0, #8C7A77)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button5() {
  return (
    <div className="relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div aria-hidden className="absolute border border-[#e8dfd5] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center p-[7px] relative size-full">
          <Icon2 />
        </div>
      </div>
    </div>
...
function ButtonMargin() {
  return (
    <div className="relative self-stretch shrink-0" data-name="Button (margin)">
...
function Container11() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Inter:Medium',sans-serif] font-medium items-center justify-between leading-[16px] not-italic relative shrink-0 text-[#8c7a77] text-[12px] text-center w-[329px] whitespace-nowrap" data-name="Container">
...
function Button6() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px not-italic relative text-[#d1d5db] text-[14px] text-center w-full">26</p>
        </div>
      </div>
    </div>
  );
...
function Button7() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px not-italic relative text-[#d1d5db] text-[14px] text-center w-full">27</p>
        </div>
      </div>
    </div>
  );
...
function Button8() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px not-italic relative text-[#d1d5db] text-[14px] text-center w-full">28</p>
        </div>
      </div>
    </div>
  );
...
function Button9() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px not-italic relative text-[#d1d5db] text-[14px] text-center w-full">29</p>
        </div>
      </div>
    </div>
  );
...
function Button10() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px not-italic relative text-[#d1d5db] text-[14px] text-center w-full">30</p>
        </div>
      </div>
    </div>
  );
...
function Button11() {
  return (
    <div className="justify-self-stretch opacity-40 relative self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#8c7a77] text-[14px] text-center whitespace-nowrap">1</p>
        </div>
      </div>
    </div>
  );
...
function Button12() {
  return (
    <div className="justify-self-stretch opacity-40 relative self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#8c7a77] text-[14px] text-center whitespace-nowrap">2</p>
        </div>
      </div>
    </div>
  );
...
function Button13() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">3</p>
        </div>
      </div>
    </div>
  );
...
function Button14() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">4</p>
        </div>
      </div>
    </div>
  );
...
function Button15() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">5</p>
        </div>
      </div>
    </div>
  );
...
function Button16() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">6</p>
        </div>
      </div>
    </div>
  );
...
function Button17() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">7</p>
        </div>
      </div>
    </div>
  );
...
function Button18() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">8</p>
        </div>
      </div>
    </div>
  );
...
function Button19() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">9</p>
        </div>
      </div>
    </div>
  );
...
function Button20() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">10</p>
        </div>
      </div>
    </div>
  );
...
function Button21() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">11</p>
        </div>
      </div>
    </div>
  );
...
function Button22() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">12</p>
        </div>
      </div>
    </div>
  );
...
function Button23() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">13</p>
        </div>
      </div>
    </div>
  );
...
function Button24() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">14</p>
        </div>
      </div>
    </div>
  );
...
function Button25() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">15</p>
        </div>
      </div>
    </div>
  );
...
function Button26() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">16</p>
        </div>
      </div>
    </div>
  );
...
function Button27() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">17</p>
        </div>
      </div>
    </div>
  );
...
function Button28() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">18</p>
        </div>
      </div>
    </div>
  );
...
function Button29() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">19</p>
        </div>
      </div>
    </div>
  );
...
function Button30() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">20</p>
        </div>
      </div>
    </div>
  );
...
function Button31() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">21</p>
        </div>
      </div>
    </div>
  );
...
function Button32() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">22</p>
        </div>
      </div>
    </div>
  );
...
function Button33() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">23</p>
        </div>
      </div>
    </div>
  );
...
function Button34() {
  return (
    <div className="bg-[#5c1d2a] drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">24</p>
        </div>
      </div>
    </div>
  );
...
function Button35() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">25</p>
        </div>
      </div>
    </div>
  );
...
function Button36() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">26</p>
        </div>
      </div>
    </div>
  );
...
function Button37() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">27</p>
        </div>
      </div>
    </div>
  );
...
function Button38() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">28</p>
        </div>
      </div>
    </div>
  );
...
function Button39() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">29</p>
        </div>
      </div>
    </div>
  );
...
function Button40() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">30</p>
        </div>
      </div>
    </div>
  );
...
function Button41() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3e2a28] text-[14px] text-center whitespace-nowrap">31</p>
        </div>
      </div>
    </div>
  );
...
function Button42() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px not-italic relative text-[#d1d5db] text-[14px] text-center w-full">1</p>
        </div>
      </div>
    </div>
  );
...
function Button43() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px not-italic relative text-[#d1d5db] text-[14px] text-center w-full">2</p>
        </div>
      </div>
    </div>
  );
...
function Button44() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px not-italic relative text-[#d1d5db] text-[14px] text-center w-full">3</p>
        </div>
      </div>
    </div>
  );
...
function Button45() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px not-italic relative text-[#d1d5db] text-[14px] text-center w-full">4</p>
        </div>
      </div>
    </div>
  );
...
function Button46() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px not-italic relative text-[#d1d5db] text-[14px] text-center w-full">5</p>
        </div>
      </div>
    </div>
  );
...
function Button47() {
  return (
    <div className="justify-self-stretch relative rounded-[8px] self-stretch shrink-0" data-name="Button">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center py-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px not-italic relative text-[#d1d5db] text-[14px] text-center w-full">6</p>
        </div>
      </div>
    </div>
  );
...
function Frame8() {
  return (
    <div className="gap-x-[6px] gap-y-[4px] grid grid-cols-[repeat(7,minmax(0,1fr))] grid-rows-[repeat(6,fit-content(100%))] h-[236px] relative shrink-0 w-full">
      <Button6 />
      <Button7 />
      <Button8 />
      <Button9 />
...
function Container8() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start p-[17px] relative rounded-[12px] shrink-0 w-[393px]" data-name="Container">
...
function Heading2() {
  return (
    <div className="h-[36px] relative shrink-0 w-[237.5px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['Playfair_Display:Regular',sans-serif] font-normal leading-[36px] left-0 text-[#3e2a28] text-[30px] top-0 whitespace-nowrap">Choose your time</p>
      </div>
    </div>
  );
}
...
function Text9() {
  return <div className="bg-[#307e50] relative rounded-[9999px] shrink-0 size-[8px]" data-name="Text" />;
}
...
function Container14() {
  return (
    <div className="relative shrink-0 w-[72.5px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <TextMargin4 />
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[#3e2a28] text-[13px] whitespace-nowrap">Available</p>
      </div>
    </div>
  );
}
...
function Text10() {
  return <div className="bg-[#c6943c] relative rounded-[9999px] shrink-0 size-[8px]" data-name="Text" />;
}
...
function ContainerMargin7() {
  return (
    <div className="h-[20px] relative shrink-0 w-[78px]" data-name="Container (margin)">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pl-[16px] relative size-full">
        <TextMargin5 />
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[#3e2a28] text-[13px] whitespace-nowrap">Limited</p>
      </div>
    </div>
  );
}
...
function Text11() {
  return <div className="bg-[#8c776e] relative rounded-[9999px] shrink-0 size-[8px]" data-name="Text" />;
}
...
function ContainerMargin8() {
  return (
    <div className="h-[20px] relative shrink-0 w-[78.5px]" data-name="Container (margin)">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pl-[16px] relative size-full">
        <TextMargin6 />
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[#3e2a28] text-[13px] whitespace-nowrap">Waitlist</p>
      </div>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="relative shrink-0 w-[229px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <Container14 />
        <ContainerMargin7 />
        <ContainerMargin8 />
...
function Button48() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[48.5px] items-center justify-center min-w-px py-[12px] relative rounded-[8px]" data-name="Button">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[22.5px] not-italic relative shrink-0 text-[#8c7a77] text-[15px] text-center whitespace-nowrap">Lunch</p>
    </div>
  );
}
...
function Button49() {
  return (
    <div className="bg-[rgba(255,255,255,0.5)] content-stretch flex flex-[1_0_0] flex-col h-[48.5px] items-center justify-center min-w-px px-px py-[13px] relative rounded-[8px]" data-name="Button">
      ...
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22.5px] not-italic relative shrink-0 text-[#3e2a28] text-[15px] text-center whitespace-nowrap">Dinner</p>
    </div>
  );
}
...
function Text12() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[61px]" data-name="Text">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22.5px] left-[30.5px] not-italic text-[#3e2a28] text-[15px] text-center top-[-1px] whitespace-nowrap">5:30 PM</p>
    </div>
  );
}
...
function Text13() {
  return <div className="bg-[#307e50] relative rounded-[9999px] shrink-0 size-[6px]" data-name="Text" />;
}

function TextMargin8() {
  return (
    <div className="relative shrink-0" data-name="Text (margin)">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start pr-[6px] relative size-full">
        <Text13 />
      </div>
    </div>
  );
...
function Container17() {
  return (
    <div className="relative shrink-0 w-[64px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <TextMargin8 />
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#307e50] text-[12px] text-center whitespace-nowrap">{`Available `}</p>
      </div>
    </div>
  );
}
...
function Button50() {
  return (
    <div className="bg-white h-full relative rounded-[12px] shrink-0 w-[136px]" data-name="Button">
      <div aria-hidden className="absolute border border-[#e8dfd5] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center px-px py-[13px] relative size-full">
          <TextMargin7 />
          <Container17 />
        </div>
      </div>
...
function Text14() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[62px]" data-name="Text">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22.5px] left-[31px] not-italic text-[#3e2a28] text-[15px] text-center top-[-1px] whitespace-nowrap">6:00 PM</p>
    </div>
  );
}
...
function Text16() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[61.5px]" data-name="Text">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22.5px] left-[31.5px] not-italic text-[#3e2a28] text-[15px] text-center top-[-1px] whitespace-nowrap">6:30 PM</p>
    </div>
  );
}
...
function Text17() {
  return <div className="bg-[#c6943c] relative rounded-[9999px] shrink-0 size-[6px]" data-name="Text" />;
}
...
function Container19() {
  return (
    <div className="relative shrink-0 w-[54px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <TextMargin12 />
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#c6943c] text-[12px] text-center whitespace-nowrap">{`Limited `}</p>
      </div>
    </div>
  );
}
...
function Text18() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[60.5px]" data-name="Text">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22.5px] left-[30px] not-italic text-[15px] text-center text-white top-[-1px] whitespace-nowrap">7:00 PM</p>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="opacity-90 relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">{`Selected `}</p>
      </div>
    </div>
  );
}
...
function Button53() {
  return (
    <div className="bg-[#5c1d2a] drop-shadow-[0px_4px_3px_rgba(0,0,0,0.1),0px_2px_2px_rgba(0,0,0,0.1)] h-full relative rounded-[12px] shrink-0 w-[136px]" data-name="Button">
...
function Text19() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[60px]" data-name="Text">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22.5px] left-[30px] not-italic text-[#3e2a28] text-[15px] text-center top-[-1px] whitespace-nowrap">7:30 PM</p>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[62px]" data-name="Text">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22.5px] left-[31px] not-italic text-[#3e2a28] text-[15px] text-center top-[-1px] whitespace-nowrap">8:00 PM</p>
    </div>
  );
}
...
function Text23() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[61.5px]" data-name="Text">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22.5px] left-[31.5px] not-italic text-[#3e2a28] text-[15px] text-center top-[-1px] whitespace-nowrap">8:30 PM</p>
    </div>
  );
}
...
function Text24() {
  return <div className="bg-[#8c776e] relative rounded-[9999px] shrink-0 size-[6px]" data-name="Text" />;
}
...
function Container23() {
  return (
    <div className="relative shrink-0 w-[54px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <TextMargin19 />
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#8c776e] text-[12px] text-center whitespace-nowrap">{`Waitlist `}</p>
      </div>
    </div>
  );
}
...
function Button56() {
  return (
    <div className="bg-white h-full opacity-50 relative rounded-[12px] shrink-0 w-[136px]" data-name="Button">
      <div aria-hidden className="absolute border border-[#e8dfd5] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center px-px py-[13px] relative size-full">
          <TextMargin18 />
...
function Text25() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[62px]" data-name="Text">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22.5px] left-[31px] not-italic text-[#3e2a28] text-[15px] text-center top-[-1px] whitespace-nowrap">9:00 PM</p>
    </div>
  );
}
...
function Text27() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[62px]" data-name="Text">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22.5px] left-[31.5px] not-italic text-[#3e2a28] text-[15px] text-center top-[-1px] whitespace-nowrap">9:30 PM</p>
    </div>
  );
}
...
function Text29() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[62px]" data-name="Text">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22.5px] left-[31.5px] not-italic text-[#3e2a28] text-[15px] text-center top-[-1px] whitespace-nowrap">10:00 PM</p>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-wrap gap-[12px] h-[149px] items-start min-w-px relative" data-name="Container">
      <Button50 />
      <Button51 />
      <Button52 />
      <Button53 />
...
function Frame6() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-start flex flex-wrap gap-y-[10px] items-start relative size-full">
        <Container16 />
      </div>
    </div>
  );
...
function Button60() {
  return (
    <div className="bg-[#5c1d2a] drop-shadow-[0px_4px_3px_rgba(0,0,0,0.1),0px_2px_2px_rgba(0,0,0,0.1)] flex-[1_0_0] min-w-px relative rounded-[12px] self-stretch" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[24px] py-[12px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">{`Next: Party Size `}</p>
          <IconMargin />
        </div>
      </div>
    </div>
...
function ContainerMargin9() {
  return (
    <div className="content-stretch flex h-[48px] items-start justify-end relative shrink-0 w-full" data-name="Container (margin)">
      <Button60 />
    </div>
  );
}
...
function Container5() {
  return (
    <div className="bg-[#faf8f2] drop-shadow-[0px_4.4px_6.6px_rgba(78,18,30,0.03)] flex-[1_0_0] min-w-px relative rounded-[17.6px]" data-name="Container">
